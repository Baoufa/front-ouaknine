...
function Contact() {
  return (
    <div className={classes.container}>
      <h1>Contacter le Cabinet Ouaknine</h1>
      <div className={classes.grid}>
        <div className={classes.leftblock}>
          <div className={classes.subtitleblock}>
            <h2 className={classes.subtitle}>Nos coordonnées</h2>
            <p>
              Lorem, ipsum dolor sit amet consectetur adipisicing elit.
              Similique voluptas sapiente cum, quo deserunt ab obcaecati laborum
              numquam, ipsam maxime laboriosam.
            </p>
          </div>
          ...
          <p>
              Le cabinet est ouvert de 9h à 17h de lundi au vendredi.
            </p>
